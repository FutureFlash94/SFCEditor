...
/**
 * This is the item provider adapter for a {@link sfcmodel.model.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider extends SfcObjectItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SFCPackage.Literals.TRANSITION__CONDITION,
				 true,
				 false,
				 false,
	...
	protected void addConstraintsRectanglePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_constraintsRectangle_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_constraintsRectangle_feature", "_UI_Transition_type"),
				 SFCPackage.Literals.TRANSITION__CONSTRAINTS_RECTANGLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addIncomingConnectionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_incomingConnections_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_incomingConnections_feature", "_UI_Transition_type"),
				 SFCPackage.Literals.TRANSITION__INCOMING_CONNECTIONS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SFCPackage.Literals.TRANSITION__OUTGOING_CONNECTIONS,
				 true,
				 false,
				 true,
				 null,
