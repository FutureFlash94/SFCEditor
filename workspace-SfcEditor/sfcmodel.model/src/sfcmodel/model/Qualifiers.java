...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Qualifiers</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see sfcmodel.model.SFCPackage#getQualifiers()
 * @model
 * @generated
 */
public enum Qualifiers implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	public static final int SD_VALUE = 7;
	 ...
	 * @ordered
	 */
	public static final int SL_VALUE = 9;
	...
	/**
	 * An array of all the '<em><b>Qualifiers</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final Qualifiers[] VALUES_ARRAY =
		new Qualifiers[] {
			NONE,
			N,
			R,
	...
	/**
	 * A public read-only list of all the '<em><b>Qualifiers</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<Qualifiers> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Qualifiers</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static Qualifiers get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Qualifiers result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Qualifiers</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static Qualifiers getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Qualifiers result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Qualifiers</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	private Qualifiers(int value, String name, String literal) {
		this.value = value;
		this.name = name;
